...
#THIS IS A SCRIPT THAT WILL PERIODICALLY RUN THROUGHOUT THE DAY TO SCAN ONENOTEBOOK TO SEE IF ANY CHANGES HAVE BEEN MADE
#IF SO, IT WILL RUN THE UPDATED DOCUMENT OR PROJECT THROUGH THE MULTI-MODAL RAG PIPELINE AND ENTER IT INTO BOTH THE VECTOR AND DOC DATABASE
